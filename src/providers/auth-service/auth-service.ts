...
export class AuthService {
  ...
  constructor(private fileTrafer1: FileTransfer, private transfer: FileTransfer, private http: HttpClient, public storage: Storage, public storage2: Storage, private file: File, public alertCtrl: AlertController) {
